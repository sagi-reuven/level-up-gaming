import { ADD_TO_CART, SUBTRACT_FROM_CART, REMOVE_ITEM_FROM_CART } from "./cart.types";
const initialState = {
  // store data
  items: [
    {
    ...
    },
    {
      ...
      desc: "The award-winning Call of Duty® series returns with Call of Duty®: Vanguard,",
      price: 55,
      details:
    ...
    },
    {
      ...
      price: 40,
      details:
        "DOOM® Eternal, the award-winning game and “one of the best first-person shooters ever” according to GameRevolution, is coming to Nintendo Switch. Developed by ...",
      brand: "xbox",
    },
    {
      id: 20,
    ...
    },
    {
      ...
      price: 50,
      details:
        "Player 1 controls Mario while Player 2 controls Cappy. This sandbox-style 3D Mario adventure—the first since 1996's beloved Super Mario 64™ and 2002's Nintendo ...",
      brand: "nintendo",
    },
    {
      id: 33,
    ...
    },
    {
      ...
      price: 40,
      details:
        "Immortals Fenyx Rising™ brings grand mythological adventure to life. Play as Fenyx, a new, winged demigod, on a quest to save the Greek gods. - Wield the powers of the gods like Achilles' sword and Daidalos' wings to battle powerful enemies and solve ancient puzzles.",
    ...
    },
    {
      ...
      desc: "DualSense wireless controllers  ",
      price: 40,
      details:
    ...
    },
    {
      ...
      price: 35,
      details:
        "Joy‑Con and Nintendo Switch™ give you total gameplay flexibility. Games come to life through easy-to-use motion controls and HD rumble—advanced vibration features built into each Joy‑Con. Depending on the game, you might use a single Joy‑Con in each hand—or even give the second one to a friend.",
