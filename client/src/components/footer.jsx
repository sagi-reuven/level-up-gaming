        ...
        <div className="container">
          <div className="row mb-5">
            ...
            <div className="col-lg-5 col-xl-4 mt-3 mt-lg-0">
              ...
              <p>
                The latest Leap news, articles, and resources, sent straight to your inbox every
                month.
              </p>

              <Link to="/signupPremium" className="btn btn-outline-danger  btn-lg mt-5">
                <span>Premium Membership </span>
              </Link>
              <br />
              <small className="text-muted form-text">
                We’ll never share your details. See our <a href="#demo">Privacy Policy</a>
              </small>
            </div>
          </div>
            ...
            <div className="col-auto">
              <ul className="nav">
                <li className="nav-item">
                  <a href="https://www.linkedin.com/in/sagi-reuven-6764b6203/" className="nav-link">
                ...
                <li className="nav-item">
                  <a href="https://github.com/sagi-reuven" target="blank" className="nav-link">
          ...
          <div className="row justify-content-center">
            <div className="col col-md-auto text-center">
              <small className="text-muted">
                &copy;{new Date().getFullYear()} This page is protected by SEO-G and is subject to
                the Google <a href="https://www.google.com/policies/privacy/">Privacy Policy</a> and{" "}
