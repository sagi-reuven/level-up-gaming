...
/* 1 taking "addedItems" from redux state 
   2 taking user to display diffrent li if user is : 
   2.1 is isnt logged 
   2.2 user is regular user 
   2.3 premium user  
*/
  ...
  data-bs-toggle="collapse"
              ...
              >
                <Link to="/store/cart" className="nav-link">
                  <motion.div
                    ...
                    <span className="colorLink cartCounter">{cartCount}</span>
                  </motion.div>
                </Link>
              </li>
            )}
          ...
          data-bs-target="#navbarsExample04"
              >
                <Link
                  to=""
                  className="btn text-white dropdown-toggle nav-link mt-1 me-2"
                  href="#"
                  role="button"
                  id="dropdownMenuLink"
                  ...
                  <motion.div
                    ...
                    <span className="colorLink">User</span>
                  </motion.div>
                </Link>

                <ul
                  className="dropdown-menu text-sm-center  bg-danger"
                  aria-labelledby="dropdownMenuLink">
                  <li className="dropdown-item "
                     data-bs-toggle="collapse"
          data-bs-target="#navbarsExample04">
                    <Link className="dropdown-item text-light ps-2 " to="/profile">
                      <i className="bi bi-person text-light me-2"></i>
                      Profile
                    </Link>
                  </li>
                  <li
          ...
          data-bs-target="#navbarsExample04"
                  >
                    <Link className="dropdown-item text-light ps-2" to="/logout">
                      <i className="bi bi-box-arrow-left text-light me-2"></i>
                      Logout
                    </Link>
                  </li>
                </ul>
